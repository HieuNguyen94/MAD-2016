...
public class UserService {
    ...
    public Response updateUsernameOld(@PathParam("param") int id, String input) throws JSONException {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response updateUsername(String input, @HeaderParam("Authorization") String auth) throws JSONException {
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    @Produces({MediaType.APPLICATION_JSON})
    public Response delUser(String input, @HeaderParam("Authorization") String auth) throws JSONException {
